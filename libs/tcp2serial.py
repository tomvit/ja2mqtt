#!/usr/bin/env python
#
# This is a modified version of the original tcp_serial_redirect.py 
...
# - when args.SERIALPORT == /dev/emulator, the serial module is replaced by serialEmulator.py module
# - the serial interface is closed in the finally block when the process ends  
...
""")
    ...
    if args.SERIALPORT == "/dev/emulator":
        # replace serial with serial emulator
        del sys.modules['serial']
        sys.modules['serial'] = __import__('serialEmulator')   
    ...
    serial_worker = ReaderThread(ser, ser_to_net)
    serial_worker.start()
